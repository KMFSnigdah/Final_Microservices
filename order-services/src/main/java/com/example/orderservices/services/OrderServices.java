...
public class OrderServices {
    ...
    public String createOrder(OrderRequestDto orderRequest){
        ...
        try{
            ...
            String responseBody = "User not found with id " + orderRequest.getUserId();

            return "Custom error: " + statusCode + ", Response: " + responseBody;
        }
        ...
        try {
            ...
            HttpStatus statusCode = ex.getStatusCode();
            String responseBody = "Product Not available or Out of stock";
